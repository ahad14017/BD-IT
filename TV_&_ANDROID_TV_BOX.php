...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-visible-on="-" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_221"><span class="moto-color5_5"><a data-action="page" data-id="30" class="moto-link" href="TV_&_ANDROID_TV_BOX.php" style = "color:white;">TV & ANDROID TV BOX</a></span></h2></div>
</div>
...
<div class="moto-widget moto-widget-container moto-container_header_59117bce6a431" data-widget="container" data-container="container" data-css-name="moto-container_header_59117bce6a431" data-bg-position="left top">
