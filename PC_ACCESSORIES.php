...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_271"><a data-action="page" data-id="30" class="moto-link" href="index1.php">ALL CATEGORIES</a></p></div>
</div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-visible-on="-" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_221"><span class="moto-color5_5"><a data-action="page" data-id="30" class="moto-link" href="PC_ACCESSORIES.php" style = "color:white;">PC ACCESSORIES</a></span></h2></div>
</div>
