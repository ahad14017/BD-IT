...
<?php 
    ...
    width: 250px; " data-src="image/product/PC_ACCESSORIES/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 250px; 
    width: 250px; " data-src="image/product/MOBILE_ACCESSORIES/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 250px; 
    width: 250px; " data-src="image/product/MUSIC_SYSTEMS/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 250px; 
    width: 250px; " data-src="image/product/TV_&_ANDROID_TV_BOX/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 250px; 
    width: 250px; " data-src="image/product/WIFI_ROUTER/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 250px; 
    width: 250px; " data-src="image/product/OTHERS/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
