...
<body>
  ...
  <div class="left" style="background-color:#000000; color:white;">
    ...
    <ul id="myMenu" >
      ...
      <li><a href="../women/perfume.php" class="active"style = "color: white;">Python</a></li>
  ...
  <div class="right" style="background-color:white;">
    ...
    <!-- products -->
		...
		<div>
		<?php 
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='1' AND item ='perfume'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
    ...
    width: 200px; "src="../image/product/perfume/'.$picture.'" class="home-prodlist-imgi">
										</a>
