...
<body>
  ...
  <div class="left" style="background-color:#000000; color:white;">
    ...
    <ul id="myMenu" >
      ...
      <li><a href="../women/ornament.php"class="active" style = "color: white;">JavaScript</a></li>
      <li><a href="../women/watch.php" style = "color: white;">PHP</a></li>
  ...
  <div class="right" style="background-color:white;">
    ...
    <!-- products -->
		...
		<div>
		<?php 
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='1' AND item ='ornament'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
    ...
    width: 200px; "src="../image/product/ornament/'.$picture.'" class="home-prodlist-imgi">
										</a>
