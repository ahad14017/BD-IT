...
<div data-widget-id="wid__menu__5c3f4e3ac4e8f" class="moto-widget moto-widget-menu moto-preset-default moto-align-center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-preset="default" data-widget="menu">
    ...
    <a href="TV_&_ANDROID_TV_BOX"   data-action="store.category" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-link">TV & android TV box</a>
        </li><li class="moto-widget-menu-item">
...
<?php 
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='1' AND item ='PC_ACCESSORIES'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
    ...
    width: 200px; " data-src="image/product/PC_ACCESSORIES/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                        ...
                        <div class="store-product-element-container">
                                ...
                                <a  class="moto-widget-button-link moto-size-medium" href="women/view_product.php?pid='.$id.'">
   	...
   	<!-- footwaer -->
		<?php 
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='1' AND item ='MOBILE_ACCESSORIES'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
					if (mysqli_num_rows($getposts)) {
					echo '<ul id="recs">';
					while ($row = $getposts -> fetch_assoc()) {
						$id = $row['id'];
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="women/view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 200px; 
    width: 200px; " data-src="image/product/MOBILE_ACCESSORIES/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
	...
	<!-- hizab -->
	<?php 
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='1' AND item ='MUSIC_SYSTEMS'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
					if (mysqli_num_rows($getposts)) {
					echo '<ul id="recs">';
					while ($row = $getposts -> fetch_assoc()) {
						$id = $row['id'];
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="women/view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 200px; 
    width: 200px; " data-src="image/product/MUSIC_SYSTEMS/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
	...
	<!-- ornament -->
	<?php 
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='1' AND item ='TV_&_ANDROID_TV_BOX'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
					if (mysqli_num_rows($getposts)) {
					echo '<ul id="recs">';
					while ($row = $getposts -> fetch_assoc()) {
						$id = $row['id'];
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="women/view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 200px; 
    width: 200px; " data-src="image/product/TV_&_ANDROID_TV_BOX/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="women/view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 200px; 
    width: 200px; " data-src="image/product/HAIR_TRIMMER_&_DRYER/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
	...
	<!--end  perfium -->
		<!--  toilatry -->
	<?php 
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='1' AND item ='WIFI_ROUTER'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
					if (mysqli_num_rows($getposts)) {
					echo '<ul id="recs">';
					while ($row = $getposts -> fetch_assoc()) {
						$id = $row['id'];
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="women/view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 200px; 
    width: 200px; " data-src="image/product/WIFI_ROUTER/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
		...
		<!--  t-sirt -->
			...
			<?php 
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='1' AND item ='OTHERS'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
					if (mysqli_num_rows($getposts)) {
					echo '<ul id="recs">';
					while ($row = $getposts -> fetch_assoc()) {
						$id = $row['id'];
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="women/view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 200px; 
    width: 200px; " data-src="image/product/OTHERS/'.$picture.'" class="moto-widget-image-picture lazyload">
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
