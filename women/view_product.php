...
<body>
  ...
  <div class="right" style="background-color:white;">
	...
	<div style="margin: 0 97px; padding: 10px">
		...
		<?php 
			echo '
				...
				<div>
					<img src="../image/product/'.$item.'/'.$picture.'" style="height: 400px; width: 400px; padding: 2px; border: 2px solid #c7587e;">
				</div>
				</div>
				<div style="float: right;width: 40%;color: #067165;background-color: #ddd;padding: 10px;">
					<div style="">
						...
						<h3 style="padding: 1px 0 0 0; font-size: 20px;">Prize: '.$price.' Tk</h3><hr>
    ...
    width: 200px; " src="../image/product/'.$item.'/'.$picture.'" class="home-prodlist-imgi">
										</a>
