...
$sold = '<div style="background: #ff4141!important;" class="moto-widget-store-main_item-label moto-text_219">SOLD!</div>';	
			...
			if (isset($_GET['keywords']) && $_GET['keywords'] != ""){
				...
				$getposts = $mysqli -> query("SELECT * FROM products WHERE pName like '%$search_value%'  ORDER BY id DESC") or die(mysql_error());
...
<span class="fa fa-star "></span>';
    ...
    width: 250px; " data-src="image/product/'.$item.'/'.$picture.'" class="moto-widget-image-picture lazyload">'.$sold_item .'
                                                                                                                                                </a>
                            </div>
