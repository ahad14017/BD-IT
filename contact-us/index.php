...
<!-- Mirrored from template59527.motopreview.com/contact-us/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Jun 2020 19:06:10 GMT -->
...
.srcbutton {
	...
	color: #ffffff;
	border: solid 0px ; border-right:0px;
	background: #00CED1;
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-animation="" data-draggable-disabled="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_2"><a href="tel:1234567890" data-action="call" class="moto-link"><?php
...
<div id="wid_1547717512_ewuwy6irq" data-widget-id="wid_1547717512_ewuwy6irq" class="moto-widget moto-widget-social-links-extended moto-preset-default moto-align-right moto-align-left_mobile-h moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto  " data-widget="social_links_extended" data-preset="default">
...
</div>                    <div class="moto-widget moto-widget-container undefined moto-container_header_5e45505d1" data-visible-on="" data-widget="container" data-container="container" data-css-name="moto-container_header_5e45505d1" data-bg-position="top" data-draggable-disabled="">
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-visible-on="-" data-animation="" data-draggable-disabled="">
    <div class="moto-widget-text-content moto-widget-text-editable" aria-multiline="true"><p class="moto-text_system_1"><a target="_self" data-action="home_page" data-anchor="" class="moto-link" href="../index.html"></a><span class="moto-content-image-plugin-wrapper moto-spacing-top-zero moto-spacing-right-zero moto-spacing-bottom-zero moto-spacing-left-zero"><span class="moto-content-image-container"><img class="moto-content-image" data-path="2017/05/mt-953_header_logo01.png" data-id="1182" alt="" width="51" height="43" src="../mt-demo/59500/59527/mt-content/uploads/2017/05/mt-953_header_logo01.png"></span></span><a target="_self" data-action="home_page" data-anchor="" class="moto-link" href="../index.php">BD-IT SHOP</a></p></div>
...
<div data-widget-id="wid__store_search__5c3f4aff5341c" class="moto-widget moto-widget-store_search moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto " data-preset="default" data-type=""
    data-widget="store_search" >
        <div store-search-widget>
        <form action="../search.php" method="GET" accept-charset="utf-8" class="search-form on">
...
<div data-widget-id="wid__store_cart_and_profile__5c3f4aff5763b" class="moto-widget moto-widget-store_cart_and_profile moto-preset-default moto-align-right moto-align-center_mobile-h moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto moto-widget-empty" data-widget="store_cart_and_profile">
        ...
        <li class="moto-widget-store_cart_and_profile-item moto-widget-store_cart_and_profile-item__cart moto-widget-text " >
            <a class="moto-widget-store_cart_and_profile-link" ng-click="handleToCart()" >
                <i class="fa fa-shopping-cart"></i>
                                <span class="moto-widget-store_cart_and_profile-text moto-text_270" data-widget="text">My Cart (<span ng-bind="widget.items_in_cart">0</span>)</span>
                                </a>
        </li>
                ...
                <a class="moto-widget-store_cart_and_profile-link" ng-click="handleToCompare()">
                    ...
                    <span class="moto-widget-store_cart_and_profile-text moto-text_270">(<span ng-bind="widget.items_in_compare">0</span>)</span>
                </a>
            </li>
        ...
        <li class="moto-widget-store_cart_and_profile-item moto-widget-store_cart_and_profile-item__compare" ng-if="widget.items_in_wish > 0">
            <a class="moto-widget-store_cart_and_profile-link" ng-click="handleToWish()">
                ...
                <span class="moto-widget-store_cart_and_profile-text moto-text_270">(<span ng-bind="widget.items_in_wish">0</span>)</span>
            </a>
        </li>
        ...
        <li class="moto-widget-store_cart_and_profile-item moto-widget-store_cart_and_profile-item__profile">
            <a class="moto-widget-store_cart_and_profile-link" ng-click="handleTargetPage()">
                ...
                <span ng-if="widget.customer" class="moto-widget-store_cart_and_profile-username moto-text_270">
...
</div><div class="moto-widget moto-widget-container moto-container_header_59116fbf2" data-widget="container" data-container="container" data-css-name="moto-container_header_59116fbf2" data-bg-position="left top" data-moto-sticky="{}">
...
<div data-widget-id="wid__menu__5c3f4aff6322f" class="moto-widget moto-widget-menu moto-preset-default moto-align-center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-preset="default" data-widget="menu">
...
</div></div></div><div class="moto-widget moto-widget-row row-fixed moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-visible-on="-" data-spacing="maaa" style="" data-bg-position="left top">
...
<div id="wid_1581601564_94w5fp8hr" class="moto-widget moto-widget-breadcrumbs moto-align-left moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto   moto-preset-default" data-widget="breadcrumbs" data-preset="default">
    <div class="moto-widget-breadcrumbs__wrapper">
        ...
        <section id="section-content" class="content page-25 moto-section" data-widget="section" data-container="section">
                                    <div class="moto-widget moto-widget-row row-fixed moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-spacing="mama" style="" data-bg-position="left top" data-draggable-disabled="" data-visible-on="-">
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><h1 style="text-align: center;" class="moto-text_system_7">Contact Us</h1></div>
</div>
...
<div data-widget-id="wid__divider_horizontal__5c3f4e75a5ed6" class="moto-widget moto-widget-divider moto-preset-2 moto-align-left moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
</div><div id="wid_1581602397_nec1ldbz8" class="moto-widget moto-widget-google-map-pro moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto " data-widget="google_map_pro">
                <div class="moto-widget-google-map-pro-wrapper"  style="height: 400px">
                    
                    
                    <iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d1824.953846441717!2d90.3570080927292!3d23.821881237857202!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1592407878511!5m2!1sen!2sbd" width="99%" height="400" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
...
<div class="moto-widget moto-widget-row moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-visible-on="-" data-spacing="maaa" style="" data-bg-position="left top" data-draggable-disabled="">
    ...
    <div  style="width:99%;" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top" ">
    
    
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-visible-on="-" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_8" style="text-align: center;">Facebook</h2></div>
</div>
...
<div data-widget-id="wid_1581603066_w56fymtzt" class="moto-widget moto-widget-facebook_page_plugin moto-align-center moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto " data-widget="facebook_page_plugin">
                <div class="fb-page" data-href="#" data-width="500" data-height="413" data-hide-cover="0" data-show-facepile="1"  data-tabs="timeline"   data-hide-cta="0" data-small-header="1" data-adapt-container-width="1">
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_8">Our Location</h2></div>
</div>
...
<div data-widget-id="wid__divider_horizontal__5c3f4e75dbd28" class="moto-widget moto-widget-divider moto-preset-2 moto-align-center moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-visible-on="-" data-animation="" data-draggable-disabled="">
    <div class="moto-widget-text-content moto-widget-text-editable" aria-multiline="true"><p class="moto-text_system_1"><a target="_self" href="../index.html" data-action="home_page" data-anchor="" class="moto-link"><span class="moto-content-image-plugin-wrapper moto-spacing-top-zero moto-spacing-right-zero moto-spacing-bottom-zero moto-spacing-left-zero cke_widget_element" data-cke-widget-data="%7B%22classes%22%3A%7B%22moto-spacing-left-zero%22%3A1%2C%22moto-spacing-bottom-zero%22%3A1%2C%22moto-spacing-right-zero%22%3A1%2C%22moto-spacing-top-zero%22%3A1%2C%22moto-content-image-plugin-wrapper%22%3A1%7D%7D" data-cke-widget-upcasted="1" data-cke-widget-keep-attr="0" data-widget="motoimagewidget"><span class="moto-content-image-container"><img class="moto-content-image" data-path="2017/05/mt-953_header_logo01.png" data-id="1182" alt="" width="51" height="43" src="../mt-demo/59500/59527/mt-content/uploads/2017/05/mt-953_header_logo01.png">​​​​​​​</span></span></a><a target="_self" href="../index.html" data-action="home_page" data-anchor="" class="moto-link">BD-IT SHOP</a></p></div>
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_normal"><span class="moto-color2_3"><strong>BD-IT SHOP</strong></span></h3><p class="moto-text_normal">Mirpur 2, Dhaka-1216</p></div>
</div>
...
<div class="moto-widget moto-widget-row moto-justify-content_center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-grid-type="xs" data-widget="row" data-spacing="aama" style="" data-bg-position="left top">
...
</div><div class="moto-widget moto-widget-row__column moto-cell col-xs-10" data-widget="row.column" data-bgcolor-class="" data-container="container" style="" data-bg-position="left top">
    
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_normal"><span class="moto-color2_3"><strong>Telephone</strong></span></h3><p class="moto-text_normal"><a data-action="call" class="moto-link" href=""><?php
$number = file_get_contents("../phone_number.txt");
echo $number;
...
</div><div class="moto-widget moto-widget-row moto-justify-content_center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-grid-type="xs" data-widget="row" data-spacing="aama" style="" data-bg-position="left top" data-draggable-disabled="">
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_normal"><span class="moto-color2_3"><strong>Opening Hours</strong></span></h3><h3 class="moto-text_normal">24 x 7 in a week</h3></div>
</div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="" data-draggable-disabled="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_normal"><span class="moto-color2_3"><strong>Comments</strong></span></h3><p class="moto-text_normal">We are glad to hear from you</p></div>
</div>
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_269">Contact info</h2></div>
</div>
...
<div data-widget-id="wid__divider_horizontal__5c3f4e75e4c5f" class="moto-widget moto-widget-divider moto-preset-default moto-align-left moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="default">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
</div><div data-widget-id="wid__contact_form__5c3f4e75eacd8" class="moto-widget moto-widget-contact_form moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto  " data-preset="default" data-widget="contact_form" data-spacing="aama">
        <div ng-controller="widget.ContactForm.Controller" ng-init="hash = '2@eyJoIjoibEE1ZEZFUFY0Z2hyY0EzWkVsXC8xVkwxWnYxb2RzaldVekh0cjZZYzJkMTQ9IiwiaSI6IlI5d0hLS0w5a3JEbWxGeGVMOU5LMkE9PSIsInYiOiJWalRiVDh1eGxKSnhHRjNjNzBcL0VUNSs4R1VnZDVlYjB0cklqZ3dtNmhRN1VtYkhPRURaaG5tdXpYaUVoeVZsVmVaNmFGU1BtNVwvczZCTkczY2hJMGxBPT0ifQ==';actionAfterSubmission={&quot;action&quot;:&quot;none&quot;,&quot;url&quot;:&quot;&quot;,&quot;target&quot;:&quot;_self&quot;,&quot;id&quot;:&quot;&quot;};resetAfterSubmission=false">
                <form class="moto-widget-contact_form-form" role="form" name="contactForm" ng-submit="submit()" novalidate  action="../mail/mail.php" method="get">
            <div ng-show="sending" class="contact-form-loading"></div>

                                                                                                        <div class="moto-widget-contact_form-group">
                            <label for="field_name_wid__contact_form__5c3f4e75eacd8" class="moto-widget-contact_form-label">YOUR NAME*</label>
                            <input type="text" class="moto-widget-contact_form-field moto-widget-contact_form-input" placeholder="YOUR NAME* *"  ng-blur="validate('name')" required  ng-model-options="{ updateOn: 'blur' }" name="name" id="field_name_wid__contact_form__5c3f4e75eacd8" ng-model="message.name"/>
                                                            <span class="moto-widget-contact_form-field-error ng-cloak" ng-cloak ng-show="contactForm.name.$invalid && !contactForm.name.$pristine && !contactForm.name.emailInvalid" >Field is required</span>
                                                                                                        ...
                                                                                                        <div class="moto-widget-contact_form-group">
                            <label for="field_email_wid__contact_form__5c3f4e75eacd8" class="moto-widget-contact_form-label">E-MAIL ADDRESS*</label>
                            <input type="text" class="moto-widget-contact_form-field moto-widget-contact_form-input" placeholder="E-MAIL ADDRESS* *"  ng-blur="validate('email')" required  ng-model-options="{ updateOn: 'blur' }" name="email" id="field_email_wid__contact_form__5c3f4e75eacd8" ng-model="message.email"/>
                                                            <span class="moto-widget-contact_form-field-error ng-cloak" ng-cloak ng-show="contactForm.email.$invalid && !contactForm.email.$pristine && !contactForm.email.emailInvalid" >Field is required</span>
                                                                    <span class="moto-widget-contact_form-field-error ng-cloak" ng-cloak ng-show="contactForm.email.emailInvalid && !contactForm.email.$pristine" >Incorrect email</span>
                                                                                                        ...
                                                                                                        <div class="moto-widget-contact_form-group">
                            <label for="field_message_wid__contact_form__5c3f4e75eacd8" class="moto-widget-contact_form-label">ENQUIRY*</label>
                            <textarea class="moto-widget-contact_form-field moto-widget-contact_form-textarea" rows="3" placeholder="ENQUIRY* *"  ng-blur="validate('message')" required  ng-model-options="{ updateOn: 'blur' }" name="message" id="field_message_wid__contact_form__5c3f4e75eacd8" ng-model="message.message"></textarea>
