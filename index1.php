...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
        ...
        <link rel="SHORTCUT ICON" href="favicon8f93.ico?_build=1592075016" type="image/vnd.microsoft.icon" />
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-visible-on="-" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_1"><a target="_self" data-action="home_page" data-anchor="" class="moto-link" href="index.html"></a><span class="moto-content-image-plugin-wrapper moto-spacing-top-zero moto-spacing-right-zero moto-spacing-bottom-zero moto-spacing-left-zero"><span class="moto-content-image-container"><img class="moto-content-image" data-path="mt-953_header_logo011.png" data-id="1182" alt="" width="60" height="43" src="mt-953_header_logo01.png"></span></span><a target="_self" data-action="home_page" data-anchor="" class="moto-link" href="index1.php">BD-IT SHOP</a></p></div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-visible-on="-" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_221"><span class="moto-color5_5"><a data-action="page" data-id="30" class="moto-link" href="index1.php" style = "color:white;">ALL CATEGORIES</a></span></h2></div>
</div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_271"><a data-action="page" data-id="22" class="moto-link" href="MOBILE_ACCESSORIES.php">MOBILE ACCESSORIES</a></p></div>
</div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="" data-draggable-disabled="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_271"><a data-action="blog.index" data-id="3" class="moto-link" href="OTHERS.php">OTHERS
...
$sold = '<div style="background: #ff4141!important;" class="moto-widget-store-main_item-label moto-text_219">SOLD!</div>';
			...
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='0' AND item ='PC_ACCESSORIES'  ORDER BY id DESC ") or die(mysql_error());
...
<span class="fa fa-star "></span>';
    ...
    width: 250px; " data-src="image/product/PC_ACCESSORIES/'.$picture.'" class="moto-widget-image-picture lazyload">'.$sold_item .'
                                                                                                                                                </a>
                            </div>
...
$sold = '<div style="background: #ff4141!important;" class="moto-widget-store-main_item-label moto-text_219">SOLD!</div>';
			...
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='0' AND item ='MUSIC_SYSTEMS'  ORDER BY id DESC ") or die(mysql_error());
					if (mysqli_num_rows($getposts)) {
					echo '<ul id="recs">';
					while ($row = $getposts -> fetch_assoc()) {
						$id = $row['id'];
...
<span class="fa fa-star "></span>';
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 250px; 
    width: 250px; " data-src="image/product/MUSIC_SYSTEMS/'.$picture.'" class="moto-widget-image-picture lazyload">'.$sold_item .'
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
...
$sold = '<div style="background: #ff4141!important;" class="moto-widget-store-main_item-label moto-text_219">SOLD!</div>';
			...
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='0' AND item ='TV_&_ANDROID_TV_BOX'  ORDER BY id DESC ") or die(mysql_error());
					if (mysqli_num_rows($getposts)) {
					echo '<ul id="recs">';
					while ($row = $getposts -> fetch_assoc()) {
						$id = $row['id'];
...
<span class="fa fa-star "></span>';
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 250px; 
    width: 250px; " data-src="image/product/TV_&_ANDROID_TV_BOX/'.$picture.'" class="moto-widget-image-picture lazyload">'.$sold_item .'
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
...
$sold = '<div style="background: #ff4141!important;" class="moto-widget-store-main_item-label moto-text_219">SOLD!</div>';
			...
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='0' AND item ='HAIR_TRIMMER_&_DRYER'  ORDER BY id DESC ") or die(mysql_error());
					if (mysqli_num_rows($getposts)) {
					echo '<ul id="recs">';
					while ($row = $getposts -> fetch_assoc()) {
						$id = $row['id'];
...
<span class="fa fa-star "></span>';
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 250px; 
    width: 250px; " data-src="image/product/HAIR_TRIMMER_&_DRYER/'.$picture.'" class="moto-widget-image-picture lazyload">'.$sold_item .'
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
...
$sold = '<div style="background: #ff4141!important;" class="moto-widget-store-main_item-label moto-text_219">SOLD!</div>';
			...
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='0' AND item ='WIFI_ROUTER'  ORDER BY id DESC ") or die(mysql_error());
					if (mysqli_num_rows($getposts)) {
					echo '<ul id="recs">';
					while ($row = $getposts -> fetch_assoc()) {
						$id = $row['id'];
...
<span class="fa fa-star "></span>';
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 250px; 
    width: 250px; " data-src="image/product/WIFI_ROUTER/'.$picture.'" class="moto-widget-image-picture lazyload">'.$sold_item .'
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
...
$sold = '<div style="background: #ff4141!important;" class="moto-widget-store-main_item-label moto-text_219">SOLD!</div>';
			...
			$getposts = $mysqli -> query("SELECT * FROM products WHERE available >='0' AND item ='OTHERS'  ORDER BY id DESC ") or die(mysql_error());
					if (mysqli_num_rows($getposts)) {
					echo '<ul id="recs">';
					while ($row = $getposts -> fetch_assoc()) {
						$id = $row['id'];
...
<span class="fa fa-star "></span>';
    ...
    <div >
                    <div class="moto-widget-store-main_item moto-widget-store-image-block ">
                                ...
                                <a class="moto-widget-image-link  moto-link" href="view_product.php?pid='.$id.'">
                                                                                                                        <img  style = "height: 250px; 
    width: 250px; " data-src="image/product/OTHERS/'.$picture.'" class="moto-widget-image-picture lazyload">'.$sold_item .'
                                                                                                                                                </a>
                            </div>
                                                <div class="moto-text_system_13 moto-widget moto-widget-text" data-widget="text">
                            <div class="moto-text_system_13">
